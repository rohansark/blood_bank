...
<head>
    ...
    <title>Bloodmate | Blood Bank</title>
                        ...
                        <div class="col-md-4 card-icon text-center">
                            <div class="card text-center card-main mx-auto">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title">Login As Hospital</h5>
                                    <a href="login_as_hospital.php" class="btn" role="button">Login</a>  
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 card-icon text-center">
                            <div class="card text-center card-main mx-auto">
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title">Login As Receiver</h5>
                                    <a href="login_as_receiver.php" class="btn" role="button">Login</a>                                   
                                </div>
                            </div>
                        </div>
                    </div>
